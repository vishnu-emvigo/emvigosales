...
export const INITIAL_LEADS: Lead[] = [
  {
    ...
    message_b: 'Hello Rachel, exciting things happening at Stealth AI Startup! We've helped similar early-stage AI companies achieve 3x pipeline growth. Open to a quick chat?',
  ...
  },
  {
    ...
    message_a: 'Hi Ali, your work at MediShout in healthcare operations is truly impactful. We specialise in helping healthtech companies expand their B2B outreach — let's connect.',
    message_b: 'Hello Ali, impressive traction with MediShout across NHS trusts! We've helped similar healthtech companies accelerate growth. Interested in a brief conversation?',
    status: 'not_assigned', assigned_to: null, selected_message: null,
    linkedin_profile_used: null, response_notes: null, reminder_date: null,
    batch_id: 'BATCH-001', upload_date: new Date().toISOString().split('T')[0],
  },
  {
    ...
    message_b: 'Hello Ioannis, Deontics is doing groundbreaking work in personalised care. We've helped similar companies achieve 2x outreach efficiency. Fancy a quick call?',
    status: 'not_assigned', assigned_to: null, selected_message: null,
    linkedin_profile_used: null, response_notes: null, reminder_date: null,
    batch_id: 'BATCH-001', upload_date: new Date().toISOString().split('T')[0],
  },
  {
    ...
    message_a: 'Hi Jonathan, your work at AROai combining AI with property analytics is really compelling. We help proptech companies like yours accelerate B2B growth — let's connect.',
    message_b: 'Hello Jonathan, exciting developments at AROai! We've helped similar proptech companies build robust sales pipelines. Would you be open to a brief chat?',
    status: 'not_assigned', assigned_to: null, selected_message: null,
    linkedin_profile_used: null, response_notes: null, reminder_date: null,
    batch_id: 'BATCH-001', upload_date: new Date().toISOString().split('T')[0],
  },
  {
    ...
    message_b: 'Hello Zoe, Joyvie Health\'s approach to personalised hormonal health is truly innovative! We\'ve helped similar healthtech startups grow 3x faster. Open to a quick chat?',
    status: 'not_assigned', assigned_to: null, selected_message: null,
    linkedin_profile_used: null, response_notes: null, reminder_date: null,
    batch_id: 'BATCH-001', upload_date: new Date().toISOString().split('T')[0],
  },
  {
    ...
    message_a: 'Hi Oliver, Koa Health\'s work in digital mental health is really impressive. We help healthtech companies like yours expand B2B outreach — let\'s connect and explore synergies.',
    message_b: 'Hello Oliver, the impact Koa Health is making in workplace mental health is remarkable! We\'ve helped similar companies build strong sales pipelines. Interested in a brief chat?',
    status: 'not_assigned', assigned_to: null, selected_message: null,
    linkedin_profile_used: null, response_notes: null, reminder_date: null,
    batch_id: 'BATCH-001', upload_date: new Date().toISOString().split('T')[0],
  },
