...
const NAV_ITEMS: NavItem[] = [
  ...
  { title: 'My Leads', url: '/my-leads', icon: Users, roles: ['sales_rep'] },
  { title: 'Unassigned', url: '/unassigned', icon: UserPlus, roles: ['sales_admin', 'sales_rep'] },
  { title: 'Assignment', url: '/assignment', icon: UsersRound, roles: ['sales_admin'] },
  { title: 'Team', url: '/team', icon: Users, roles: ['sales_admin'] },
  { title: 'Reminders', url: '/reminders', icon: Bell, roles: ['sales_rep'] },
