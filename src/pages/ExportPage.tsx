...
const ExportPage = () => {
  ...
  const exportCsv = (data: typeof leads, filename: string) => {
    const headers = ['Sr No', 'Full Name', 'Company', 'Location', 'LinkedIn URL', 'Status', 'Assigned To', 'LinkedIn Profile Used', 'Response Notes', 'Reminders', 'Batch ID', 'Upload Date'];
    const rows = data.map(l => [
      l.sr_no, l.full_name, l.company, l.location, l.linkedin_url, l.status,
      l.assigned_to || '', l.linkedin_profile_used || '',
